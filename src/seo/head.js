...
export function renderHeadTags(head) {
  ...
  return [
    ...
    head.modifiedTime ? `<meta property="og:updated_time" content="${escapeHtml(head.modifiedTime)}">` : '',
    head.publishedTime ? `<meta property="article:published_time" content="${escapeHtml(head.publishedTime)}">` : '',
    head.modifiedTime ? `<meta property="article:modified_time" content="${escapeHtml(head.modifiedTime)}">` : '',
