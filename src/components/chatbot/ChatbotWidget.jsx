      ...
      <AnimatePresence>
        {open ? (
          <motion.section
            ...
            className="mb-3 w-[calc(100vw-2rem)] max-w-[370px] overflow-hidden rounded-2xl border border-white/15 bg-zinc-950/95 shadow-[0_20px_65px_rgba(0,0,0,0.5)] backdrop-blur-xl"
