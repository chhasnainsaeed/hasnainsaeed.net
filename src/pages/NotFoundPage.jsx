      ...
      <section className="section-pad py-24">
        <div className="section-wrap premium-card p-10 text-center">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <Link to="/" className="inline-flex rounded-full bg-orange-500 px-6 py-3 text-sm font-semibold text-black">
              Return Home
            </Link>
            <Link to="/portfolio" className="inline-flex rounded-full border border-white/20 px-6 py-3 text-sm font-semibold text-zinc-200">
              View Portfolio
            </Link>
          </div>
        </div>
